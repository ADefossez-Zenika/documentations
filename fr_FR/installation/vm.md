...
-   Cliquez sur suivant, adaptez la taille de la mémoire par rapport à votre système (1024 sont suffisants)
-   Cliquez sur suivant, créez un disque virtuel maintenant
...
-   Dans l'onglet réseau, choisissez "accès par pont" dans le mode d’accès réseau.
![VirtualBox3](images/VirtualBox3.PNG)
-   Cliquez sur OK
-   Cliquez sur démarrer

Selectionnez "Install on disk" (touche entrée du clavier), validez avec yes (touche flèche bas puis entrée). Toute la suite va se faire automatiquement (10 à 30min), puis une fois la vm redemarrée, attendez 5min et vous devriez avoir accès à Jeedom en mettant simplement l'ip de jeedom dans un navigateur.
...
> **Warning**
>
> Si cela ne fonctionne pas, vous n’avez pas configuré votre carte réseau en Pont réseau comme indiqué au départ.
